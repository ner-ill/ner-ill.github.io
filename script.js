(() => {
  ...
  //ここから
  const detailLink = (title, description, url) =>
  url
  ...
  //ここまでを変更
//変更前のコード　const detailLink = (title, description, url) => `<section class="detail-entry"><h2><a href="${esc(url)}">${title}<span aria-hidden="true">→</span></a></h2><p>${description}</p></section>`;

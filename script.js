(() => {
  ...
  const galleryContent = game.gallery.length ? `<div class="gallery-grid">${game.gallery.map((g,i)=>galleryButton(g,i)).join('')}</div>` : '<p class="empty">準備中</p>';
